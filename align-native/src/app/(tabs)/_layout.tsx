  ...
  return (
    <>
      <Tabs screenOptions={{
        ...
        tabBarStyle: { backgroundColor: colors.backgroundElement, borderTopWidth: 1, borderTopColor: colors.border, elevation: 0, shadowOpacity: 0, height: 64 + insets.bottom, paddingBottom: insets.bottom },
